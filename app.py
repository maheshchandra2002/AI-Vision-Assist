...
GEMINI_API_KEY = "AIzaSyDkVfU8oM4NFFxGPVze2VlgJfTMKfi41QU"  # Replace with your valid API key
...
def text_to_speech_gtts(text):
    """Converts the given text to speech and plays it using gTTS."""
...
if uploaded_file:
    ...
    if tts_button:
        with st.spinner("Converting text to speech..."):
            text = extract_text_from_image(image)
            if text.strip():
                text_to_speech_gtts(text)  # Use gTTS-based function
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️ 2024 - Mahesh Bodepudi | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
